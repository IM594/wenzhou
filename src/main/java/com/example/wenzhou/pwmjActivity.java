...
public class pwmjActivity extends AppCompatActivity {
    MapView mMapView;
    Double la,lg;
    ImageView like;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pwmj);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("name","五马街");
                cv.put("content","被命名为国家级「百城万店无假货」示范街");
                cv.put("kind","吃喝");
                if(dbWriter.insert("love",null,cv)<0){
                    //table为想要插入数据的表名字 nullColunmnHack为是否允许有空行 values为要插入的值 第一条为0
                    Toast.makeText(pwmjActivity.this, "收藏失败", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(pwmjActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
