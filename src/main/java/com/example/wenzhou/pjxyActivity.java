...
public class pjxyActivity extends AppCompatActivity {
    MapView mMapView;
    Double la,lg;
    ImageView like;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pjxy);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("name","江心屿");
                cv.put("content","历来被称为“瓯江蓬莱”");
                cv.put("kind","山水");
                if(dbWriter.insert("love",null,cv)<0){
                    //table为想要插入数据的表名字 nullColunmnHack为是否允许有空行 values为要插入的值 第一条为0
                    Toast.makeText(pjxyActivity.this, "收藏失败", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(pjxyActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
