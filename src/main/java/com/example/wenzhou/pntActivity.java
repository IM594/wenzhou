    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("name","印象南塘");
                cv.put("content","已成为极具特色的“温州城市客厅”");
                cv.put("kind","吃喝");
                if(dbWriter.insert("love",null,cv)<0){
                    //table为想要插入数据的表名字 nullColunmnHack为是否允许有空行 values为要插入的值 第一条为0
                    Toast.makeText(pntActivity.this, "收藏失败", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(pntActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
